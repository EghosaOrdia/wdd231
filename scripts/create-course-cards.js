...
courses.forEach((course) => {
  ...
  courseCard.dataset.category = `ALL ${course.subject}`;
  courseCard.dataset.credit = course.credits;
  ...
  // Combine them
  courseCard.append(courseCode, courseTitle, courseDescription, courseCredits);
